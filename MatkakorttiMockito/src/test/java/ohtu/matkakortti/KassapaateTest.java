...
public class KassapaateTest {
    ...
    @Test
    public void kortilleLisataanRahaaKunSummaPositiivinen() {
        kassa.lataa(kortti, 30);
        
        verify(kortti, times(1)).lataa(eq(30));
    }
    
    @Test
    public void kortilleEiLisataRahaaKunSummaNegatiivinen() {
        kassa.lataa(kortti, -30);
        
        verify(kortti, times(0)).lataa(eq(-30));
    }
